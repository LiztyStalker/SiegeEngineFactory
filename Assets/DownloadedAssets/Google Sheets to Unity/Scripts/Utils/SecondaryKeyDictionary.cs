...
namespace GreenerGames
{
    ...
    public class SecondaryKeyDictionary<T1, T2, V>
    {
        ...
        public Dictionary<T1, V>.KeyCollection PrimaryKeys => primaryDictionary.Keys;
        public Dictionary<T1, V>.ValueCollection PrimaryValues => primaryDictionary.Values;

        public Dictionary<T2, T1>.KeyCollection SecondaryKeys => secondaryKeyLink.Keys;
        public Dictionary<T2, T1>.ValueCollection SecondaryValues => secondaryKeyLink.Values;
    ...
    public class SecondaryKeyDictionary<T, V>
    {
        ...
        public Dictionary<T, V>.KeyCollection Keys => primaryDictionary.Keys;
        public Dictionary<T, V>.ValueCollection Values => primaryDictionary.Values;
