namespace SEF.Data.Editor
{
    ...
    public class VillageDataEditor : Editor
    {
        ...
        public void OnEnable()
        {
            ...
            var visualTree = AssetDatabase.LoadAssetAtPath<VisualTreeAsset>("Assets/Scripts/Data/ScriptableObject/VillageData/Editor/VillageDataEditor.uxml");
            visualTree.CloneTree(_root);

            var styleSheet = AssetDatabase.LoadAssetAtPath<StyleSheet>("Assets/Scripts/Data/ScriptableObject/VillageData/Editor/VillageDataEditor.uss");
